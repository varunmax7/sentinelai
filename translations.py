# translations.py - COMPLETE VERSION
TRANSLATIONS = {
    'en': {
        # Navigation
        'home': 'Home',
        ...
        'report_hazard_description': 'Submit geotagged reports with photos or videos of observed ocean hazards.',
        'analytics_description': 'Access real-time crowdsourced data and advanced analytics tools.',
        ...
        'trending_hazards': 'Trending Hazards',
        'quick_actions': 'Quick Actions',
        'community_feed': 'Community Feed',
        'register_to_report': 'Register to Report',
        'no_recent_activity': 'No recent activity. Be the first to contribute!',
        'no_reports_yet': 'No reports yet. Be the first to report!',
        'loading': 'Loading',
        'loading_live_trends': 'Loading live trends...',
        'at': 'at',
...
def translate(key, **kwargs):
    """Translation helper function that can be imported by forms"""
    from flask import g
